...
function App() {
  ...
  // -- the setSessionToken method we get through arr destructuring of our useState method is only available in App.js
  // - therefore, our updateToken method needs to also be in App.js.
  ...
  const clearToken = () => {
    ...
    localStorage.clear()
    // resetting state of sessionToken back to an empty string
    setSessionToken('')
  }
