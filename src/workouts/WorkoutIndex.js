...
const WorkoutIndex = props => {
  // workouts are an arr filled with workout objects returned from WOL server
  ...
  // including auth header (so server knows who is making request and understands them.
  ...
  // -- the useEffect fn only once--as the component initially loads
  // We want to load workouts from fetchWorkouts fn automatically (1 time) as the component loads to the DOM.
  useEffect(() => {
    fetchWorkouts()
  }, [])
